...
Summary: [תיאור קצר וטבעי של הכיוון, במשפט אחד או שניים. אל תפתחי את הסיכום במילים סרטון, ריל, רילס, סטורי או פוסט, כי סוג התוכן כבר מוצג בנפרד ויוצא כפל. התחילי ישר מהתוכן עצמו]
`;
